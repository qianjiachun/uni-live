export function initHuyaDanmaku() {
    var Taf = Taf || {};
Taf.INT8 = function() {
...
function HuYaListener(topsid,subsid,msgHandler) {
    ...
    function e() {
        ...
        n.tId = a, n.lTopcid = G.topsid, n.lSubcid = G.subsid, n.sSendContent = "", s.sendWup("liveui", "userIn", n);
    }

    function i() {
        var n = new HUYA.GetPropsListReq;
        n.tUserId = a, n.sMd5 = "", n.iTemplateType = HUYA.EClientTemplateType.TPL_PC, n.sVersion = "", s.sendWup("PropsUIServer", "getPropsList", n)
    }
...
window.HuYaListener = HuYaListener;
}